...
public class BetManagerTest extends TestBase {
  ...
  public void testBetUntilAllAreSatisfiedTwoPlayerRaises() {
    ...
    when(player1.decideAction(Matchers.any(Draw.class), anyInt(), anyList(), anyInt(),anyInt(), anyInt())).thenReturn(
    ...
    when(player2.decideAction(Matchers.any(Draw.class), anyInt(), anyList(), anyInt(),anyInt(), anyInt())).thenReturn(
        new Action(ActionEnum.RAISE)).thenReturn(
            new Action(ActionEnum.CHECK));
  ...
  public void testBetAllCheck() {
    ...
    when(peter.decideAction(Matchers.any(Draw.class), anyInt(), anyList(), anyInt(),anyInt(), anyInt())).thenReturn(
        new Action(ActionEnum.CHECK));
    ...
    when(thomas.decideAction(Matchers.any(Draw.class), anyInt(), anyList(), anyInt(),anyInt(), anyInt())).thenReturn(
        new Action(ActionEnum.CHECK));
    ...
    when(anders.decideAction(Matchers.any(Draw.class), anyInt(), anyList(), anyInt(),anyInt(), anyInt())).thenReturn(
    ...
    when(bosse.decideAction(Matchers.any(Draw.class), anyInt(), anyList(), anyInt(),anyInt(), anyInt())).thenReturn(
    ...
    when(staffan.decideAction(Matchers.any(Draw.class), anyInt(), anyList(), anyInt(),anyInt(), anyInt())).thenReturn(
        new Action(ActionEnum.CHECK));
